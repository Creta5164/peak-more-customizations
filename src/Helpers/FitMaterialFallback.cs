...
public static class FitMaterialFallback {
    ...
    private static readonly (string, float)[] FLOATS = [
    ...
    private static readonly (string, Color)[] COLORS = [
    ...
    /// <summary>
    /// Fallback material for character model.
    /// Missing some texture references for _Texture1 (cf8299178f38cfc4bbc8cad77f945042)
    /// and _Texture2 (8eb990cc0cb1e17439402d1501c7f607)
    /// </summary>
