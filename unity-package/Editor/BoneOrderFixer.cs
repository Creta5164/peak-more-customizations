...
namespace MoreCustomizations.Tools {
    ...
    //the following Bind poses are sourced directly from an extracted vanilla outfit:
        static readonly string BIND_POSES = @"
    e00: 0.8258692
    e01: -0
    e02: -0
    e03: -0
  ...
  - e00: 0.8258692
    ...
    e33: 1";
        ...
        void OnPostprocessModel(GameObject prefab)
        {
            ...
            var bindPoses = BIND_POSES.Trim().Split(" - ").Select(bindPose =>
            {
